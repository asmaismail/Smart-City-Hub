...
const AdminHouses = () => {
  ...
  const handleDeleteClick = (light) => {
    console.log(`Deleting ${light}`);
  };
  const handleEditClick = (light) => {
    console.log(`Editing ${light}`);
  };
  return (
    <>
                    ...
                    {[
                      {
                        name: "Light 01",
                        state: "on",
                        description: "description of this light(can be empty)",
                      ...
                      <tr className="border-t-2 h-[50px]" key={light.name}>
                        ...
                        <td className="h-[25px]">
                          ...
                          <button
                            ...
                            onClick={() => handleDeleteClick(light.name)}
                          >
                            delete
                          </button>
                          <button
                            className="btn btn-dark"
                            onClick={() => handleEditClick(light.name)}
                          >
                            edit
                          </button>
                        </td>
